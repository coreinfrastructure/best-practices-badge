...
- <a name="report-process"></a>The project MUST provide a process for users to submit bug reports (e.g., using an issue tracker or a mailing list). It is SUGGESTED that an issue tracker be used for tracking individual issues. <sup>[<a href="#report-process">report-process</a>]&#8224;</sup>
- <a name="report-tracker"></a>If an issue tracker is used, it MUST be publicly readable and have a stable URL. <sup>[<a href="#report-tracker">report-tracker</a>]&#8224;</sup>
