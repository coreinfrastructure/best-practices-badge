...
- <a name="delivery-unsigned"></a>A cryptographic hash (e.g., a sha1sum) MUST NOT be retrieved over http and used without checking for a cryptographic signature.  These hashes can be modified in transit. <sup>[<a href="#delivery-unsigned">delivery-unsigned</a>]</sup>
