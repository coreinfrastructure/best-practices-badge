...
gem 'actionmailer', '6.1.3.2' # Rails. Send email.
gem 'actionpack', '6.1.3.2' # Rails. MVC framework.
gem 'actionview', '6.1.3.2' # Rails. View.
gem 'activejob', '6.1.3.2' # Rails. Async jobs.
gem 'activemodel', '6.1.3.2' # Rails. Model basics.
gem 'activerecord', '6.1.3.2' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
gem 'activesupport', '6.1.3.2' # Rails. Underlying library.
...
gem 'puma', '5.2.2' # Faster webserver; recommended by Heroku
...
# We no longer say: gem 'rails', '6.1.3.2' # Our web framework
...
gem 'railties', '6.1.3.2' # Rails. Rails core, loads rest of Rails
...
group :development do
  ...
  gem 'rails', '6.1.3.2' # Rails (our web framework)
