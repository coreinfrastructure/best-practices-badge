...
gem 'actionpack', '~> 7.0.6' # Rails. MVC framework.
gem 'actionview', '~> 7.0.6' # Rails. View.
gem 'activejob', '~> 7.0.6' # Rails. Async jobs.
gem 'activemodel', '~> 7.0.6' # Rails. Model basics.
gem 'activerecord', '~> 7.0.6' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
...
gem 'railties', '~> 7.0.6' # Rails. Rails core, loads rest of Rails
