...
gem 'scout_apm', '2.4.14' # Monitor for memory leaks
gem 'secure_headers', '6.0.0' # Add hardening measures to HTTP headers
gem 'uglifier', '4.1.14', require: false # Minify JavaScript
...
group :test do
  ...
  gem 'chromedriver-helper', '1.2.0', require: false # for capybara-selenium
