...
- <a name="crypto-published"></a>The project MUST use cryptographic protocols and algorithms within the software and the delivery mechanisms that are publicly published and reviewed by experts. <sup>[<a href="#crypto-published">crypto-published</a>]*</sup>
...
- <a name="crypto-password-storage"></a>If passwords are stored for authentication, the project MUST store them as iterated hashes with a per-user salt.  <sup>[<a href="#crypto-password-storage">crypto-password-storage</a>]*</sup>
