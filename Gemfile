...
gem 'blind_index', '0.3.2' # Index encrypted email addresses
gem 'bootstrap-sass', '3.3.7'
gem 'bootstrap-social-rails', '4.12.0'
gem 'bootstrap-will_paginate', '1.0.0'
gem 'bootstrap_form', '2.7.0'
gem 'chartkick', '2.3.5' # Chart project_stats
...
gem 'rails', '5.1.6.1' # Our web framework
...
gem 'scout_apm', '2.4.18' # Monitor for memory leaks
gem 'secure_headers', '6.0.0' # Add hardening measures to HTTP headers
gem 'uglifier', '4.1.19', require: false # Minify JavaScript
...
group :development do
  gem 'bootsnap', '1.3.2' # Speed up boot via caches
