...
<li><a name="version_semver"></a>It is SUGGESTED that the <a href="http://semver.org">Semantic Versioning (SemVer) format</a> be used for releases.
 <sup>[<a href="#version_semver">version_semver</a>]</sup><dl><dt><i>Details</i>:<dt> <dd>Other schemes like commit IDs, or date-based schemes like YYYYMMDD, MAY be used as version numbers. They are unique, but note that these can cause problems for users as they may not be able to easily determine whether or not they're up-to-date.
