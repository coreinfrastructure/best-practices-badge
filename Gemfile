...
gem 'rails', '5.1.5' # Our web framework
gem 'rails-i18n', '5.1.0' # Localizations for Rails built-ins
gem 'redcarpet', '3.4.0' # Process markdown in form textareas (justifications)
gem 'sass-rails', '5.0.7', require: false
gem 'scout_apm', '2.4.8' # Monitor for memory leaks
...
group :development, :test do
  ...
  gem 'bullet', '5.7.3' # Avoid n+1 queries
...
group :development do
  ...
  gem 'translation', '1.12' # translation.io - translation service
