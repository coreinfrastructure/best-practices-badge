...
gem 'scout_apm', '2.3.2' # Monitor for memory leaks
gem 'secure_headers', '5.0.4' # Add hardening measures to HTTP headers
gem 'uglifier', '4.0.2', require: false # Minify JavaScript
...
group :development, :test do
  ...
  gem 'bullet', '5.7.0' # Avoid n+1 queries
...
group :development do
  gem 'bootsnap', '1.1.7' # Speed up boot via caches
  ...
  gem 'translation', '1.11' # translation.io - translation service
