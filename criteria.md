...
*   Security:
    ...
    -   Encryption mechanisms must make use of open standards and follow best practices such as strong cipher suites and perfect forward secrecy whenever possible.
*   Security analysis:
