...
gem 'actionmailer', '6.1.7' # Rails. Send email.
gem 'actionpack', '6.1.7' # Rails. MVC framework.
gem 'actionview', '6.1.7' # Rails. View.
gem 'activejob', '6.1.7' # Rails. Async jobs.
gem 'activemodel', '6.1.7' # Rails. Model basics.
gem 'activerecord', '6.1.7' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
gem 'activesupport', '6.1.7' # Rails. Underlying library.
...
# We no longer say: gem 'rails', '6.1.7' # Our web framework
...
gem 'railties', '6.1.7' # Rails. Rails core, loads rest of Rails
gem 'rails-i18n', '7.0.6' # Localizations for Rails built-ins
...
group :development do
  ...
  gem 'rails', '6.1.7' # Rails (our web framework)
