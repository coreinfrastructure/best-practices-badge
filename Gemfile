...
gem 'paper_trail', '8.0.0' # Record previous versions of project data
...
gem 'scout_apm', '2.3.1' # Monitor for memory leaks
gem 'secure_headers', '5.0.1' # Add hardening measures to HTTP headers
...
group :development do
  gem 'bootsnap', '1.1.5' # Speed up boot via caches
  ...
  gem 'translation', '1.10' # translation.io - translation service
...
group :test do
  ...
  gem 'minitest-reporters', '1.1.18', require: false
  ...
  gem 'selenium-webdriver', '3.6.0', require: false
