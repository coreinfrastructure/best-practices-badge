...
gem 'rails', '5.2.4.3' # Our web framework
...
group :development, :test do
  ...
  gem 'rubocop', '0.67.2' # Style checker.  Changes can cause test failure
  # gem 'rubocop-performance', '1.0.0' # Performance-specific cops (rubocop)
