...
group :development, :test do
  ...
  gem 'rubocop', '0.84.0', require: false # Style checker
  gem 'rubocop-performance', '1.7.1', require: false # Performance cops
  gem 'rubocop-rails', '2.4.0', require: false # Rails-specific cops
